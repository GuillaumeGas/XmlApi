...
public:
	...
	XmlTag(std::string name, std::string nameSpace, Position pos, bool isClose = false, bool isSingle = false);
	XmlTag(std::string name, std::vector<XmlAttrPtr> * attributes, Position pos, bool isSingle = false);
	XmlTag(std::string name, std::string nameSpace, std::vector<XmlAttrPtr> * attributes, Position pos, bool isSingle = false);

	static XmlTagPtr make(std::string name, Position pos, bool isClose = false, bool isSingle = false);
	static XmlTagPtr make(std::string name, std::string nameSpace, Position pos, bool isClose = false, bool isSingle = false);
	static XmlTagPtr make(std::string name, std::vector<XmlAttrPtr> * attributes, Position pos, bool isSingle = false);
	static XmlTagPtr make(std::string name, std::string nameSpace, std::vector<XmlAttrPtr> * attributes, Position pos, bool isSingle = false);
